...
{
    function __construct(string $identifier = 'contact-data', string $name = 'Contact', array $screen = [], string $context = 'advanced', string $priority = 'default')
    {
	...
	{
		$phone = get_post_meta( $post->ID, '_contact-street', TRUE );
